...
- **Corridor ray-cast hazard set is a parameter**, default {bunker, water, water_creek, outside, deep_rough} (deep_rough ≈ trees); fairway/green/tee/semi_rough/rough/path are in-play. Math is pure in `shared/strategy/`, operating on flattened EPSG:3006 rings.
